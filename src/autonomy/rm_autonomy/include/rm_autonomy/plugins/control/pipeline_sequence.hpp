...
#ifndef RM_AUTONOMY__PLUGINS__CONTROL__PIPELINE_SEQUENCE_HPP_
#define RM_AUTONOMY__PLUGINS__CONTROL__PIPELINE_SEQUENCE_HPP_
...
#endif  // RM_AUTONOMY__PLUGINS__CONTROL__PIPELINE_SEQUENCE_HPP_