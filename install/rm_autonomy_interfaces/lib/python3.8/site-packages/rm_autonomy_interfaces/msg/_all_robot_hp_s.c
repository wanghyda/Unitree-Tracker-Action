...
bool rm_autonomy_interfaces__msg__all_robot_hp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_autonomy_interfaces.msg._all_robot_hp.AllRobotHP", full_classname_dest, 51) == 0);
  }
  rm_autonomy_interfaces__msg__AllRobotHP * ros_message = _ros_message;
  {  // red_1_hp
...
PyObject * rm_autonomy_interfaces__msg__all_robot_hp__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_autonomy_interfaces.msg._all_robot_hp");
