...
{
  new (message_memory) rm_autonomy_interfaces::msg::GameStatus(_init);
}

void GameStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_autonomy_interfaces::msg::GameStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GameStatus_message_member_array[2] = {
  {
    ...
    offsetof(rm_autonomy_interfaces::msg::GameStatus, stage_progress),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_autonomy_interfaces::msg::GameStatus, stage_remain_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GameStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(rm_autonomy_interfaces::msg::GameStatus),
...
{
  return &::rm_autonomy_interfaces::msg::rosidl_typesupport_introspection_cpp::GameStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_autonomy_interfaces, msg, GameStatus)() {
  return &::rm_autonomy_interfaces::msg::rosidl_typesupport_introspection_cpp::GameStatus_message_type_support_handle;
}
