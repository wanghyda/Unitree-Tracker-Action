...
#include "rm_autonomy_interfaces/msg/detail/omni_sensing__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_autonomy_interfaces::msg::OmniSensing & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_autonomy_interfaces::msg::OmniSensing & ros_message)
{
  // Member: target_yaw
  cdr >> ros_message.target_yaw;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rm_autonomy_interfaces
max_serialized_size_OmniSensing(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const rm_autonomy_interfaces::msg::OmniSensing *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_autonomy_interfaces::msg::OmniSensing *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OmniSensing__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rm_autonomy_interfaces::msg::OmniSensing *>(
...
{
  return max_serialized_size_OmniSensing(full_bounded, 0);
}

static message_type_support_callbacks_t _OmniSensing__callbacks = {
...
static rosidl_message_type_support_t _OmniSensing__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_OmniSensing__callbacks,
...
{
  return &rm_autonomy_interfaces::msg::typesupport_fastrtps_cpp::_OmniSensing__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_autonomy_interfaces, msg, OmniSensing)() {
  return &rm_autonomy_interfaces::msg::typesupport_fastrtps_cpp::_OmniSensing__handle;
}
