...
static const _FireTrigger_type_support_symbol_names_t _FireTrigger_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_autonomy_interfaces, msg, FireTrigger)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_autonomy_interfaces, msg, FireTrigger)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_autonomy_interfaces, msg, FireTrigger)() {
  return &::rm_autonomy_interfaces::msg::rosidl_typesupport_c::FireTrigger_message_type_support_handle;
}
