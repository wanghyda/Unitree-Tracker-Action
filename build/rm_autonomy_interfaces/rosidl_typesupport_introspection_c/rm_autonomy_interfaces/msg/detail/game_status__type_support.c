...
#include <stddef.h>
#include "rm_autonomy_interfaces/msg/detail/game_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rm_autonomy_interfaces__msg__GameStatus__init(message_memory);
}

void GameStatus__rosidl_typesupport_introspection_c__GameStatus_fini_function(void * message_memory)
{
  rm_autonomy_interfaces__msg__GameStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GameStatus__rosidl_typesupport_introspection_c__GameStatus_message_member_array[2] = {
  {
    "stage_progress",  // name
    ...
    offsetof(rm_autonomy_interfaces__msg__GameStatus, stage_progress),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_autonomy_interfaces__msg__GameStatus, stage_remain_time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GameStatus__rosidl_typesupport_introspection_c__GameStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(rm_autonomy_interfaces__msg__GameStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_autonomy_interfaces, msg, GameStatus)() {
